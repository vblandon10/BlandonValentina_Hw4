...
{ // hacer los calculos del proyectil que se dispara con cada angulo
	...
	archivo_adicional << i << endl; // almacenar cuantas lineas corresponden a cada proyectil

	cout << "Dsitancia recorrida en x= " << x0 << endl;
	cout << "Trayectoria calculada para proyectil a " << angulo << " grados" << endl << endl;
